...
const mapDispatchToProps = dispatch => {
    return {
        onCreateNews: (userId, article, imageFiles) => dispatch(actions.createNews(userId, article, imageFiles)),
        onCreateNewsReset: () => dispatch(actions.createNewsReset()),
